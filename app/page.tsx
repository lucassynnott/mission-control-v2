...
import { Menu, Bot, Columns, Activity, Shield } from "lucide-react";
    ...
    return (
      <div className="h-screen flex flex-col bg-cyber-dark font-cyber overflow-hidden">
        ...
        <div className="flex-1 grid grid-cols-[280px_1fr_300px] overflow-hidden">
          {/* Left sidebar */}
          <div className="border-r-2 border-cyber-red/30 relative">
          ...
          {/* Right sidebar */}
          <div className="border-l-2 border-cyber-red/30 relative">
    ...
    <div className="h-screen flex flex-col bg-cyber-dark font-cyber overflow-hidden">
      ...
      <nav className="h-16 border-t-2 border-cyber-red/50 bg-cyber-panel flex items-center justify-around px-1">
        <Button
          variant="ghost"
          size="sm"
          className={`flex-col h-14 px-3 rounded-none border-b-2 ${activeTab === 'agents' ? 'text-cyber-red border-cyber-red bg-cyber-red/10' : 'text-cyber-cyan/60 border-transparent hover:text-cyber-cyan'}`}
        ...
        <Button
          variant="ghost"
          size="sm"
          className={`flex-col h-14 px-3 rounded-none border-b-2 ${activeTab === 'kanban' ? 'text-cyber-red border-cyber-red bg-cyber-red/10' : 'text-cyber-cyan/60 border-transparent hover:text-cyber-cyan'}`}
        ...
        <Button
          variant="ghost"
          size="sm"
          className={`flex-col h-14 px-3 rounded-none border-b-2 ${activeTab === 'activity' ? 'text-cyber-red border-cyber-red bg-cyber-red/10' : 'text-cyber-cyan/60 border-transparent hover:text-cyber-cyan'}`}
